...
from engine.processing.prepare_data import _build_indexable_text
from engine.retrieval.domain import detect_domain
...
from engine.utils.circuit_breaker import CircuitBreaker, CircuitBreakerProxy
...
def test_build_summary_document_uses_summary_metadata():
    from engine.processing.prepare_data import _build_summary_document
...
def test_article_splitter_preserves_parent_article_text():
    from engine.processing.prepare_data import ArticleTextSplitter

...
ВАЖНО: Генерируй только те запросы, которые напрямую следуют из исходного вопроса пользователя.
НЕ добавляй детали или обстоятельства, которых нет в вопросе.
НЕ расширяй вопрос на смежные темы (возраст, вид имущества, обстоятельства совершения) если они не упомянуты явно.
Запросы должны быть максимально близкими перефразами исходного вопроса.

...
CODE_NAMES = {
    ...
    "law_on_advertising.txt": ("Закон о рекламе РК", "Жарнама туралы заң"),
    ...
    "law_on_digital_assets.txt": ("Закон о цифровых активах", "Цифрлық активтер туралы заң"),
    ...
    "law_on_access_to_information.txt": (
    ...
    "law_on_electronic_document_signature.txt": (
        ...
        "Электрондық құжат және электрондық цифрлық қолтаңба туралы заң",
    ),
    "law_on_mass_media.txt": ("Закон о масс-медиа", "Масс-медиа туралы заң"),
    "law_on_state_secrets.txt": ("Закон о государственных секретах", "Мемлекеттік құпиялар туралы заң"),
    ...
    "law_on_informatization.txt": ("Закон об информатизации", "Ақпараттандыру туралы заң"),
    "law_on_migration_of_population.txt": (
        "Закон о миграции населения",
        "Халықтың көші-қоны туралы заң",
    ),
    "law_on_languages.txt": ("Закон о языках в РК", "Қазақстан Республикасындағы тілдер туралы заң"),
}

...
RETRIEVER_HYBRID_V3_QUERY_LIMIT = int(
    os.environ.get("LEGAL_RAG_RETRIEVER_HYBRID_V3_QUERY_LIMIT", "6")
)
RETRIEVER_QUERY_DECOMPOSITION_MIN_CHARS = int(
    os.environ.get("LEGAL_RAG_RETRIEVER_QUERY_DECOMPOSITION_MIN_CHARS", "220")
)
...
EXPERIMENTAL_HYBRID_V3_RETRIEVAL = (
    os.environ.get("LEGAL_RAG_EXPERIMENTAL_HYBRID_V3_RETRIEVAL", "0") == "1"
)
EXPERIMENTAL_NEIGHBOR_EXPANSION = (
    os.environ.get("LEGAL_RAG_EXPERIMENTAL_NEIGHBOR_EXPANSION", "0") == "1"
)
RETRIEVER_NEIGHBOR_EXPANSION_WINDOW = int(
    os.environ.get("LEGAL_RAG_RETRIEVER_NEIGHBOR_EXPANSION_WINDOW", "1")
)

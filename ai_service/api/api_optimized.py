...
from ai_service.utils.query_cache import cached_rag_response, get_cache_stats

logger = logging.getLogger("ai_service.api.optimized")
...
async def clear_cache_endpoint():
    ...
    try:
        from ai_service.utils.query_cache import clear_cache
        count = clear_cache()
...
async def chat_fast(request: Request, body: ChatRequest):
    ...
    try:
        ...
        if not body.stream:
            from ai_service.utils.query_cache import generate_cache_key, cache_get

...
def test_build_summary_and_comparison():
    results = [
        {"metrics": {"strict_hit": 1.0, "soft_hit": 1.0, "mrr": 1.0}},
        {"metrics": {"strict_hit": 0.0, "soft_hit": 1.0, "mrr": 0.5}},
    ]

    summary = _build_summary(results, top_k=5)
    comparison = _build_comparison(summary, {"strict_hit@k": 0.25, "soft_hit@k": 0.5, "mrr": 0.4})

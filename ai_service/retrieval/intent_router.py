...
SOCIAL_PATTERNS = [
    r"^(привет|здравствуй|добрый день|хай|прив|салам|ассалаумағалейкум|сәлем|сәлеметсіз бе|сәлеметсізбе|сәлем берем)",
    r"^(как дела|как поживаешь|что нового|қалайсың|жағдай қалай)",
    r"^(кто ты|что ты умеешь|чем можешь помочь|расскажи о себе|сен кімсің|не істей аласың)",
    r"^(спасибо|благодарю|рахмет|ок|хорошо|понятно|спасибо за помощь|түсінікті|жақсы|келістік)$",
    r"^(пока|до свидания|сау бол|көріскенше)$"
]
